if(SNAX_CDT_ROOT STREQUAL "" OR NOT SNAX_CDT_ROOT)
   set(SNAX_CDT_ROOT "@CDT_ROOT_DIR@")
endif()

list(APPEND CMAKE_MODULE_PATH ${SNAX_CDT_ROOT}/lib/cmake/snax.cdt)
if (NOT SNAX_WASM_OLD_BEHAVIOR STREQUAL "Off")
    set(SNAX_WASM_OLD_BEHAVIOR "On")
    include(SnaxWasmToolchain)
endif()
...
function(SNAX_CHECK_VERSION output version hard_min soft_max hard_max) # optional 6th argument for error message
...
endfunction(SNAX_CHECK_VERSION)
