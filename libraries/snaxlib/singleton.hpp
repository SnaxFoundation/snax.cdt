...
#warning "<snaxlib/singleton.hpp> is deprecated use <snax/singleton.hpp>"
namespace  snax {

   /**
    *  @defgroup singleton Singleton Table
    *  @ingroup contracts
    *  @brief Defines SNAX Singleton Table used with %multiindex
    *  @{
    */
   ...
   class singleton
   {
      ...
      public:
         ...
         T get() {
            ...
            snax::check( itr != _t.end(), "singleton does not exist" );
            return itr->value;
         }
