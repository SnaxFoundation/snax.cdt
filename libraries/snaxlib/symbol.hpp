...
#warning "<snaxlib/symbol.hpp> is deprecated use <snax/symbol.hpp>"
namespace snax {
   ...
   */
   ...
   public:
      ...
      */
      ...
      friend inline DataStream& operator<<(DataStream& ds, const snax::symbol_code sym_code) {
      ...
      */
      template<typename DataStream>
      friend inline DataStream& operator>>(DataStream& ds, snax::symbol_code& sym_code) {
         uint64_t raw = 0;
