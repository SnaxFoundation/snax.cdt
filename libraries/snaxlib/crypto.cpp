...
namespace snax {
   ...
   snax::public_key recover_key( const snax::checksum256& digest, const snax::signature& sig ) {
      ...
      char sig_data[70];
      snax::datastream<char*> sig_ds( sig_data, sizeof(sig_data) );
      ...
      snax::datastream<char*> pubkey_ds( pubkey_data, pubkey_size );
      snax::public_key pubkey;
      pubkey_ds >> pubkey;
      return pubkey;
   }
   ...
   void assert_recover_key( const snax::checksum256& digest, const snax::signature& sig, const snax::public_key& pubkey ) {
      ...
      char pubkey_data[38];
      snax::datastream<char*> pubkey_ds( pubkey_data, sizeof(pubkey_data) );
