...
#warning "<snaxlib/types.h> is deprecated use <snax/types.h>. If you are using C++ the .h header files will be removed from inclusion entirely in v1.7.0"
...
/**
 * SNAX Public Key. It is 34 bytes.
 */
