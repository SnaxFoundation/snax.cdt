...
namespace snax {
   ...
   inline DataStream& operator<<(DataStream& ds, const ::snax::ignore_wrapper<T>& val) {
     ds << val.value;
     return ds;
   }
    ...
    */
   template<typename DataStream, typename T>
   inline DataStream& operator<<(DataStream& ds, const ::snax::ignore<T>& val) {
     return ds;
   }
    ...
    */
   template<typename DataStream, typename T>
   inline DataStream& operator>>(DataStream& ds, ::snax::ignore<T>&) {
     return ds;
   }
}
