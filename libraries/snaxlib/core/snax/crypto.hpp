...
namespace snax {
   ...
   inline DataStream& operator<<(DataStream& ds, const snax::public_key& pubkey) {
      ds << pubkey.type;
    ...
    */
   template<typename DataStream>
   inline DataStream& operator>>(DataStream& ds, snax::public_key& pubkey) {
      ds >> pubkey.type;
    ...
    */
   template<typename DataStream>
   inline DataStream& operator<<(DataStream& ds, const snax::signature& sig) {
      ds << sig.type;
    ...
    */
   template<typename DataStream>
   inline DataStream& operator>>(DataStream& ds, snax::signature& sig) {
      ds >> sig.type;
