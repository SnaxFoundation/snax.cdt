### Usage
---
To manually compile the source code, use `snax-cpp/snax-cc` and `snax-ld` as if it were __clang__ and __lld__. All the includes and options specific to SNAX and CDT are baked in.

###$ snax-cpp
---
```
USAGE: snax-cpp [options] <input file> ...
