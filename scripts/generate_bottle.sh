...
mkdir -p ${PROJECT}/${VERSION}/opt/snax_cdt/lib/cmake
...
echo "class SnaxCdt < Formula

   homepage \"${URL}\"
   revision 0
   url \"https://github.com/snax/snax.cdt/archive/v${VERSION}.tar.gz\"
   version \"${VERSION}\"
   ...
   bottle do
      root_url \"https://github.com/snax/snax.cdt/releases/download/v${VERSION}\"
