# Purpose
The `ricardsnax.py` imports or exports Ricardian contracts to and from a contract's ABI file.

## Import Example
`$ python3 ricardsnax.py import /path/to/source-contract.abi /path/to/new-smart-contract-abi.abi`
...
## Export Example
`$ python3 ricardsnax.py export /path/to/source-contract.abi`
